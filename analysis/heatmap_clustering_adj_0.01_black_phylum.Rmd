---
title: "Phylum Heatmap [LOD & Herit] (adjusted [0.01])"
...
### Phylum
```{r phylum load, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r phylum figures cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r phylum peaks cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r phylum figures stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r phylum peaks stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
