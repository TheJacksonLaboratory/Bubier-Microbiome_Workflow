---
title: "Order Heatmap [LOD & Herit] (adjusted [0.01])"
...
### Order
```{r order load, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r order figures cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r order peaks cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r order figures stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r order peaks stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
