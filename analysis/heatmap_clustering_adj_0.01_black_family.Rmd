---
title: "Family Heatmap [LOD & Herit] (adjusted [0.01])"
...
### Family
```{r family load, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#a01 <- min(apa$`0.01`)
print(a01)
x01 <- sample(apx[which(apx$"0.01" < 11),]$`0.01`, 1)
#x01 <- min(apx$`0.01`)
print(x01)
...
#### Figures
```{r family figures cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r family peaks cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r family figures stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r family peaks stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
