---
title: "Class Heatmap [LOD & Herit] (adjusted [0.01])"
...
### Class
```{r class load, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r class figures cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r class peaks cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r class figures stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r class peaks stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
