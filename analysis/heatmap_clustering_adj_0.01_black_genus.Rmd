---
title: "Genus Heatmap [LOD & Herit] (adjusted [0.01])"
...
### Genus
```{r genus load, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r genus figures cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r genus peaks cecum, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Figures
```{r genus figures stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
...
#### Peaks
```{r genus peaks stool, fig.height = 6, fig.width = 9.5, fig.align = "center"}
